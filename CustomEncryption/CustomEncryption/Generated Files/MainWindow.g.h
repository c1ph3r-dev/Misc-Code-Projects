...
namespace winrt::CustomEncryption::implementation
{
    ...
    struct __declspec(empty_bases) MainWindow_base : implements<D, CustomEncryption::MainWindow, composing, I...>,
        impl::require<D, winrt::Microsoft::UI::Xaml::IWindow>,
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        using base_type = MainWindow_base;
        using class_type = CustomEncryption::MainWindow;
        ...
        {
            return L"CustomEncryption.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::CustomEncryption::factory_implementation
{
    ...
    {
        using instance_type = CustomEncryption::MainWindow;
