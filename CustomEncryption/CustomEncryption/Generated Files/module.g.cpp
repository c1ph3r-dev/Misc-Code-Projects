...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"CustomEncryption.MainWindow"))
    {
        return winrt_make_CustomEncryption_MainWindow();
    }

    if (requal(name, L"CustomEncryption.XamlMetaDataProvider"))
    {
        return winrt_make_CustomEncryption_XamlMetaDataProvider();
    }
