...
namespace winrt::J_Encrypter::implementation
{
    ...
    struct __declspec(empty_bases) MainWindow_base : implements<D, J_Encrypter::MainWindow, composing, I...>,
        impl::require<D, winrt::Microsoft::UI::Xaml::IWindow>,
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        using base_type = MainWindow_base;
        using class_type = J_Encrypter::MainWindow;
        ...
        {
            return L"J_Encrypter.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::J_Encrypter::factory_implementation
{
    ...
    {
        using instance_type = J_Encrypter::MainWindow;
