...
#pragma once
#include "winrt/J_Encrypter.h"
#include "winrt/Microsoft.UI.Xaml.Markup.h"
namespace winrt::J_Encrypter::implementation
{
    template <typename D, typename... I>
    struct __declspec(empty_bases) XamlMetaDataProvider_base : implements<D, J_Encrypter::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = J_Encrypter::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"J_Encrypter.XamlMetaDataProvider";
        }
    };
}
namespace winrt::J_Encrypter::factory_implementation
{
    ...
    {
        using instance_type = J_Encrypter::XamlMetaDataProvider;
