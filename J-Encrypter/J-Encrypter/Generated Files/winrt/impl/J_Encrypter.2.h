...
#pragma once
#ifndef WINRT_J_Encrypter_2_H
#define WINRT_J_Encrypter_2_H
#include "winrt/impl/Microsoft.UI.Xaml.1.h"
#include "winrt/impl/Microsoft.UI.Xaml.Markup.1.h"
#include "winrt/impl/J_Encrypter.1.h"
WINRT_EXPORT namespace winrt::J_Encrypter
{
    struct __declspec(empty_bases) MainWindow : winrt::J_Encrypter::IMainWindow,
        ...
        impl::require<MainWindow, winrt::Microsoft::UI::Xaml::IWindow>
    {
        ...
        MainWindow(void* ptr, take_ownership_from_abi_t) noexcept : winrt::J_Encrypter::IMainWindow(ptr, take_ownership_from_abi) {}
        MainWindow();
    };
