...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"J_Encrypter.MainWindow"))
    {
        return winrt_make_J_Encrypter_MainWindow();
    }

    if (requal(name, L"J_Encrypter.XamlMetaDataProvider"))
    {
        return winrt_make_J_Encrypter_XamlMetaDataProvider();
    }
